...
def cadastro(request):
    ...
    try:
        ...
        path_template = os.path.join(settings.BASE_DIR, 'autenticacao/templates/emails/confirmar_cadastro.html')
        email_html(path_template, 'Ative seu perfil - NutriLab', [email,], username = username, link_ativacao = f"127.0.0.1:8000/auth/ativar_conta/{token}")
